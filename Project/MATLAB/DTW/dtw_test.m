...
[d1, sr] = audioread('test/Jeremy_a_piece_of_cake_1.wav');
[d2, sr] = audioread('test/Jeremy_a_piece_of_cake_1.wav');
...
%  D1 = specgram(d1(:,1), 512, sr, 512, 384);
%  D2 = specgram(d2(:,1), 512, sr, 512, 384);
% 
