...
\noindent In \ref{fig:stress_ex} is given an example in which more emphases is given when pronouncing that particular sentence. The big black dots represent such emphasis.
