...
\begin{figure}[!ht]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/main.png}
		\captionof{Pronunciation (or Main) page of PARLA}
		\label{fig:pronunciation_page}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/listening.png}
		\captionof{Listening page}
...
\begin{figure}[!ht]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/history2.png}
		\caption{Example of History page}
		\label{fig:history2_page}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/history.png}
...
\begin{figure}[!ht]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/error_rate1.png}
		\captionof{Correct pronunciation}
		\label{fig:error_rate_page}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/error_rate2.png}
		\captionof{Small error in pronunciation}
		\label{fig:error_rate2_page}
	\end{minipage}
\end{figure}

\noindent It is important to mention that all the charts are
...
\begin{figure}[!ht]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/pitch.png}
		\captionof{Stress countour chart}
		\label{fig:pitch_page}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[scale=0.22]{Figures/screenshots/vowels.png}
		\captionof{Vowels prediction representation}
